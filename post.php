        ...
        <div class="content-wrap">		
            <article class="post" itemscope itemtype="http://schema.org/BlogPosting">				
                ...
                <header class="post-header">					
                    <h1 class="post-title" itemprop="name headline"><?php $this->title() ?></h1>										<span class="round-date red">				<span class="month"><?php echo date('m月', $this->modified);?></span>				<span class="day"><?php echo date('d', $this->modified);?></span>				</span>					
                    <div class="post-meta">
